...
module.exports={
  ...
  files:['desktop/**','public/**','scripts/remote-terminal.mjs','scripts/ssh-askpass.cjs','scripts/ssh-askpass.mjs','*.mjs','codex-*.schema.json','package.json','build/icon.png','build/licenses/**','THIRD-PARTY-NOTICES.md','!tests/**','!data/**','!.env','!node_modules/**','!scripts/prepare-desktop.mjs','!scripts/launch-office.mjs'],
