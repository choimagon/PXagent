export const AGENT_CAPABILITIES = {
  ...
  analyzer: {defaultSkills:['document-analysis'],availableSkills:['document-analysis','pdf-analysis','paper-analysis','statistical-analysis','table-analysis','research'],role:'문서 부서의 읽기·분석 전담. PDF/DOCX/PPTX/MD/TXT/CSV와 일반 파일을 읽고 주장·근거·표·그림·수식·한계를 구조화한다. 원본을 수정하지 않는다. 페이지·절·파일 위치를 근거에 포함하고 확인하지 못한 내용을 명시한다.'},
...
export const ADDITIONAL_AGENTS = [
  {id:'analyzer',name:'분석이',role:'파일 분석 · 문서 부서',department:'문서 부서',reportsTo:'chief',profile:'terra',reasoningEffort:'high',color:'#c0b0da',appearance:'doctor',prompt:AGENT_CAPABILITIES.analyzer.role},
