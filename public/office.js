...
function shelf(x,y,books=true) {
  ...
  for (let row=0;row<2;row++) for (let i=0;i<9;i++) contents+=rect(7+i*8,8+row*32+(i%3)*2,6,22-(i%3)*2,books?colors[(i+row)%6]:'#86948a');
...
export function officeMarkup() {
  ...
  ${windowArt(302,59)}${shelf(49,82,false)}${plant(43,216)}
  ...
  ${server(698,76)}${server(755,76)}${server(812,76)}${plant(459,206)}
  ...
  ${shelf(50,350)}${shelf(380,350)}${plant(49,505)}${plant(444,509)}
  ...
  ${rect(723,352,114,28,'#78816a')}${rect(727,356,106,20,'#444f43')}${rect(733,361,94,2,'#b4b18a')}${rect(733,366,67,2,'#8e9478')}
